...
/*
 ****** ATENÇÃO ******
 * Este router foi congelado para demonstrar o uso de middleware. Ao adicionar o model no projeto o arquivo foi
 * marcado como "descontinuado" (ganhou um sufixo).
 */
